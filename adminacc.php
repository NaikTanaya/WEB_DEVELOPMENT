...
<head>
    ...
    <title>ADMIN | Pet Adoption Portal</title>
  ...
  <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                   ...
                   <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><img src="images/logo.jpg"  width="15% "/> Pet Adoption Portal</h4></a>
                </div>
...
<div class="container wow fadeInDown">
    <div class="row">
        ...
        <center><img src="images/profile.png" class="img-responsive wow fadeInDown" style="height:200px;" /></center>
        <div>
            <?php
                session_start();
